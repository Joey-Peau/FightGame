...
public abstract class Character implements Fightable, Statable {
    ...
    @Override
    public int attack(Fightable enemy, boolean isCritical) {
        int lpToRemove = this.getAttackPoints();
        ...
        int real_removed;
        real_removed = enemy.removeLife(lpToRemove);
    ...
    public String toString() {
        return "Level : " + this.level + "\n"
                ...
                + ((this instanceof Levelable) ? "Exp: " + ((Levelable) this).getExp() + "/" + ((Levelable) this).getExpForNextLevel() + "\n" : "")
